...
public class Ejercicio5_Lavadero_Runnable {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                int numAuto = obtenerNumeroAuto();
                Runnable auto = new AutoRunnable(numAuto);
    ...
    static class AutoRunnable implements Runnable {
        ...
        public AutoRunnable(int numAuto) {
        ...
        public void run() {
            try {
                ...
                // Cobrar y actualizar saldo (synchronized)
                int nuevoSaldo = actualizarSaldo(500);
    ...
    // Método synchronized para obtener número de auto
    private static synchronized int obtenerNumeroAuto() {
        contadorAutos++;
        return contadorAutos;
    }
    
    // Método synchronized para actualizar el saldo
    private static synchronized int actualizarSaldo(int cantidad) {
        saldo += cantidad;
        return saldo;
    }
}