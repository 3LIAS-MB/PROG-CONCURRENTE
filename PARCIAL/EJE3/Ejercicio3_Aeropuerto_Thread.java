...
public class Ejercicio3_Aeropuerto_Thread {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                Thread taxi = new TaxiThread(numPasajeros);
                taxi.start();
    ...
    static class TaxiThread extends Thread {
        private int numPasajeros;
        private String terminal;
        
        public TaxiThread(int numPasajeros) {
        ...
        public void run() {
            ...
            for (int i = 0; i < numPasajeros; i++) {
                ...
                Thread pasajero = new PasajeroThread(numPasajero, terminal);
                pasajero.start();
            }
        }
    }
    
    static class PasajeroThread extends Thread {
        private int numPasajero;
        private String terminal;
        
        public PasajeroThread(int numPasajero, String terminal) {
