...
public class Ejercicio2_PlantaEnsamblado_Runnable {
    ...
    public static void main(String[] args) {
        // Crear 100 componentes usando Runnable
        for (int i = 1; i <= 100; i++) {
            Runnable componente = new ComponenteRunnable(i);
            Thread hilo = new Thread(componente);
            hilo.start();
        }
    }
    
    // Clase que implementa Runnable
    static class ComponenteRunnable implements Runnable {
        private int numComponente;
        
        public ComponenteRunnable(int num) {
